    ...
    <Layout>
      <div className="bg-white dark:bg-gray-900 pt-32 pb-24 transition-colors duration-300 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 p-8 md:p-10 flex flex-col h-full min-h-[280px]">
                    ...
                    <div className="mt-12">
                      <h2 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-3 leading-tight">
                        {product.name}
                      </h2>
          ...
          {/* Bottom CTA */}
          <div className="mt-24 md:mt-32 rounded-3xl p-8 md:p-16 bg-gray-900 dark:bg-black text-center relative overflow-hidden">
            <div
