...
const PrivacyPolicy: React.FC = () => {
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Information We Collect</h3>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Cookies and Tracking Technologies</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">How We Use Your Information</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Disclosure & Sharing of Information</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">International Transfers</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Data Retention</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Security</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Your Rights & Choices</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Children’s Privacy</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Changes to the Policy</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Links to Other Sites</h3>
 <p>
