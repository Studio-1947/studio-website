...
const TermsOfService: React.FC = () => {
 ...
 <a href="https://www.1947.io/" className="text-royal-600 hover:underline mx-1">https://www.1947.io/</a>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Use of the Site and Services</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Eligibility</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Registration/Form Fillup</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">User Content</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Intellectual Property</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Prohibited Activities</h3>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Modifications to the Services</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Third-Party Links and Integrations</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Limitation of Liability</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Indemnification</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Termination</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Governing Law</h3>
 <p>
 ...
 <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Changes to These Terms</h3>
 <p>
 ...
 <a href="mailto:studio@1947.io" className="text-royal-600 hover:underline">studio@1947.io</a>
 </p>
 <p className="flex items-center">
 <span className="font-semibold text-gray-900 w-32">Call/WhatsApp:</span>
 <a href="tel:+917207680813" className="text-royal-600 hover:underline">+91 72076 80813</a>
 </p>
 </div>
 </div>
 </div>
