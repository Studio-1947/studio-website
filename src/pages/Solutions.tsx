...
const Solutions: React.FC = () => {
  ...
  usePageMeta({ title: 'Solutions – Studio 1947', description: 'From brand strategy to web development, data analytics to film production — Studio 1947 delivers integrated solutions that scale.' });
