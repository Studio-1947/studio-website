 ...
 */}
 ...
 {/* Section Header */}
 <div className="mb-16">
 <span className="inline-block text-xs font-bold tracking-[0.25em] uppercase text-royal-600 mb-4">
 Open Positions
 </span>
 ...
 <p className="text-lg text-gray-500 max-w-xl mt-6">
 ...
 <div className="group relative flex flex-col justify-between p-8 md:p-10 border-b md:border-b-0 md:border-r border-gray-200 hover:bg-gray-50 transition-colors duration-300">
 <div>
 <span className="inline-block text-[10px] font-bold tracking-widest uppercase px-2 py-1 border border-royal-600 text-royal-600 mb-6">
 Creative
 </span>
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="mt-10 inline-flex items-center text-sm font-bold text-gray-900 group-hover:text-royal-600 transition-colors"
 >
 Apply for this role
 ...
 <div className="group relative flex flex-col justify-between p-8 md:p-10 hover:bg-gray-50 transition-colors duration-300">
 <div>
 <span className="inline-block text-[10px] font-bold tracking-widest uppercase px-2 py-1 border border-royal-600 text-royal-600 mb-6">
 Design
 </span>
 ...
 <div className="mt-12 pt-10 border-t border-gray-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="shrink-0 inline-flex items-center justify-center px-7 py-3 text-sm font-bold text-white bg-gray-900 hover:bg-royal-700 transition-all duration-300 hover:-translate-y-0.5"
 >
 Introduce Yourself
