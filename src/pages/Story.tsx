...
export default function Story() {
 ...
 return (
 <Layout>
 <div className="bg-[#f4efe8] text-gray-900 min-h-screen font-sans transition-colors duration-300" ref={containerRef}>
 <div className="flex flex-col md:flex-row w-full relative">

 {/* Left Side: Sticky Canvas */}
 <div className="w-full md:w-1/2 h-[50vh] md:h-screen md:sticky top-0 left-0 bg-black overflow-hidden border-b md:border-b-0 md:border-r border-[#d3c5b3] z-10 flex items-center justify-center">
 ...
 <div
 key={sec.id}
 className="min-h-screen flex flex-col justify-center px-8 sm:px-12 md:px-16 lg:px-24 py-24 border-b border-[#d3c5b3]/30 last:border-0"
 >
 {index === 0 ? (
 <div className="text-center md:text-left">
 <span className="text-[#a46f4b] font-semibold tracking-widest uppercase text-sm mb-6 block">
 Our Story
 </span>
 <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-[#3a2d24] tracking-tight leading-tight">
 {sec.title}
 </h1>
 </div>
 ) : (
 <div className="relative">
 <span className="absolute -left-6 md:-left-8 top-1 text-[#a46f4b]/30 font-black text-4xl">
 {index}
 </span>
 <p className="text-xl md:text-2xl text-[#5c4a3d] leading-relaxed font-light">
 {sec.content}
 </p>
 </div>
 )}
