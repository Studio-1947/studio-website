...
export default function Initiative() {
 ...
 return (
 <div
 className="min-h-screen bg-[#f7f4ee] text-gray-900 pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300"
 ref={containerRef}
 >
 {/* Background Ambience */}
 <div className="absolute inset-0 pointer-events-none">
 <div className="absolute top-0 left-1/4 w-[40rem] h-[40rem] bg-indigo-500/15 rounded-full blur-[120px] mix-blend-multiply" />
 <div className="absolute bottom-0 right-1/4 w-[30rem] h-[30rem] bg-amber-500/15 rounded-full blur-[100px] mix-blend-multiply" />
 ...
 Our{" "}
 <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-950 via-gray-900 to-gray-800">
 Initiatives
 </span>
 </h1>
