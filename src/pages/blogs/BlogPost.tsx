...
const BlogPost: React.FC = () => {
 ...
 return (
 <Layout>
 <article className="bg-white pt-24 md:pt-32 pb-24 transition-colors duration-300 min-h-screen">

 {/* Article Header */}
 <header className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 md:mb-16 text-center">
 <Link
 to="/blogs"
 className="inline-flex items-center text-royal-600 hover:text-royal-800 font-medium mb-8 md:mb-12 transition-colors uppercase tracking-wider text-sm"
 >
 ...
 Written by <span className="text-royal-600">{blog.author}</span>
 </span>
 </div>
 ...
 <div className="prose prose-lg md:prose-xl prose-royal mx-auto">
 ...
 return (
 <li key={idx} className="text-gray-700 leading-relaxed mb-4 ml-4">
 ...
 <span className="text-royal-600 font-medium">Culture</span>
 <span className="text-royal-600 font-medium">Stories</span>
 </div>
 ...
 <button
 onClick={handleShare}
 className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-royal-600 hover:text-white transition-colors"
 title="Share article"
 >
