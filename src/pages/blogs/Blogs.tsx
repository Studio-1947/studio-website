...
const Blogs: React.FC = () => {
 ...
 <Link to={`/blogs/${blog.slug}`} className="block relative rounded-2xl overflow-hidden mb-6 shadow-md shadow-gray-200 aspect-[4/3] bg-gray-100">
 ...
 <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-royal-600 transition-colors">
 ...
 <Link
 to={`/blogs/${blog.slug}`}
 className="inline-flex items-center text-sm font-bold text-royal-600 group-hover:text-royal-700"
 >
 Read More
