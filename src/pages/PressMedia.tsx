          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[1fr_1.15fr] lg:items-center">
              ...
              <div>
                ...
                <h1 className="mt-6 text-4xl md:text-6xl lg:text-5xl xl:text-6xl font-black leading-[1] tracking-tight text-gray-950 dark:text-white">
                ...
                <div className="mt-10 grid grid-cols-3 gap-6 max-w-xl lg:mt-12">
                  <article>
                    <p className="text-3xl md:text-4xl font-black text-royal-600 dark:text-royal-400">
                      1
                    </p>
                    <p className="mt-2 text-sm font-semibold uppercase tracking-[0.1em] text-gray-600 dark:text-gray-400">
                      Featured Press
                    </p>
              ...
              {pressItems.map((article) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="hidden lg:block w-full max-w-xl lg:justify-self-center group relative overflow-hidden rounded-[2rem] border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl dark:border-gray-800 dark:bg-gray-900"
                >
                  ...
                  <div className="relative z-10 flex h-full flex-col p-8">
                    ...
                    <h2 className="mt-5 text-2xl font-black leading-tight text-gray-950 dark:text-white">
                      {article.title}
                    </h2>
                    ...
                    <p className="mt-5 flex-1 text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                      {article.summary}
                    </p>

                    <span className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-royal-700 dark:text-royal-300">
                      Read article
        ...
        <section className="py-6 md:py-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {eventItems.map((item) => {
              ...
              const cardClassName =
                "group relative block mb-6 overflow-hidden rounded-[2rem] border border-gray-200 bg-white shadow-sm transition-all duration-300 dark:border-gray-800 dark:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-royal-500/20";
              const ctaClassName = hasMedia
                ? "shrink-0 items-center justify-center rounded-full border border-gray-200 bg-white px-5 py-3 text-sm font-bold text-gray-900 shadow-sm dark:border-gray-800 dark:bg-gray-950 dark:text-white flex gap-2 group-hover:border-royal-600 group-hover:bg-royal-600  dark:group-hover:bg-royal-600 dark:group-hover:border-royal-600"
                : "shrink-0 items-center justify-center rounded-full border border-gray-300 bg-gray-100 px-5 py-3 text-sm font-bold text-gray-500 shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 flex gap-2";
              const content = (
                <>
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-white dark:from-gray-900 dark:via-gray-900 dark:to-gray-950 transition-colors group-hover:from-royal-50 group-hover:to-white dark:group-hover:from-royal-950/10 dark:group-hover:to-gray-950" />
                  <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 p-7 md:p-8">
                    <div className="min-w-0">
                      <div className="flex items-center gap-3 text-gray-500 dark:text-gray-400">
                        <Icon className="w-5 h-5 shrink-0 text-royal-600 dark:text-royal-400 transition-transform duration-300 group-hover:scale-110" />
                        <span className="text-sm font-semibold uppercase tracking-[0.2em]">
                          {item.eyebrow}
                        </span>
                      </div>
                      <h3 className="mt-4 text-2xl md:text-3xl font-black text-gray-950 dark:text-white transition-colors group-hover:text-royal-600 dark:group-hover:text-royal-400">
                        {item.title}
                      </h3>
                      <p className="mt-4 max-w-3xl text-base leading-relaxed text-gray-600 dark:text-gray-300 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">
                        {item.description}
                      </p>
                    </div>
