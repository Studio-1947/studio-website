...
const Collabs: React.FC = () => {
 ...
 <span className="inline-block py-1.5 px-4 rounded-full bg-royal-100 text-royal-700 font-bold tracking-widest uppercase text-sm mb-6 border border-royal-200">
 Partnerships
 </span>
 <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-gray-900 tracking-tight leading-tight mb-8">
 Collaborations<br />
 <span className="text-transparent bg-clip-text bg-gradient-to-r from-royal-600 via-indigo-500 to-emerald-500">
 Better together.
 </span>
 </h1>
 ...
 className="group block relative bg-white rounded-[2.5rem] p-8 md:p-12 border border-gray-100 hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-1"
 >
 ...
 <div className="w-32 h-32 md:w-48 md:h-48 rounded-full bg-gray-50 flex items-center justify-center p-6 border border-gray-200 shadow-inner group-hover:scale-105 transition-transform duration-500">
 <img
 src={collab.logo}
 ...
 <h2 className="text-3xl md:text-4xl font-bold text-gray-900 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-gray-900 group-hover:to-gray-600 transition-all duration-300">
 {collab.name}
 </h2>
 ...
 <div className="w-8 h-8 ml-3 rounded-full bg-white flex items-center justify-center shadow-sm">
