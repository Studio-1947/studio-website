...
const WalkingProject: React.FC = () => {
 ...
 return (
 <Layout>
 <article className="bg-white min-h-screen text-gray-900 transition-colors duration-300">
 ...
 <div
 className="absolute inset-0 -z-0 opacity-10 pointer-events-none bg-[url('/collabs/walkingproject/walkingprojectlogo.svg')] bg-no-repeat bg-center bg-cover md:bg-[length:100%_auto] filter grayscale mix-blend-multiply"
 ></div>
 ...
 <Link to="/" className="inline-flex items-center text-gray-500 hover:text-black font-medium mb-12 transition-colors group">
 ...
 className="text-xl md:text-2xl text-gray-600 font-light leading-relaxed border-l-4 border-yellow-500 pl-6"
 >
 <p>
 ...
 className="w-full aspect-[21/9] bg-gray-100 rounded-3xl overflow-hidden relative group border border-gray-200"
 >
 <img
 ...
 viewport={{ once: true }}
 transition={{ duration: 0.6 }}
 className="w-full aspect-video md:aspect-[21/9] bg-gray-900 rounded-3xl overflow-hidden relative group border border-gray-200 max-w-5xl mx-auto shadow-xl"
 >
 <img
