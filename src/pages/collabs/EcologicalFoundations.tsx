          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-start">
              ...
              <div className="lg:col-span-5">
                <div className="w-16 h-16 rounded-2xl bg-emerald-50 dark:bg-gray-800 flex items-center justify-center p-3 border border-emerald-100 dark:border-gray-700 mb-8">
                  <img src="/collabs/ecologicalfoundation.png" alt="Ecological Foundations" className="w-full h-full object-contain" />
                </div>

                <span className="inline-block px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 text-xs font-bold uppercase tracking-widest mb-6">
                  Collaboration
                </span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-8">
                <blockquote className="text-2xl md:text-3xl font-light text-gray-700 dark:text-gray-300 leading-relaxed border-l-4 border-emerald-500 pl-8">
              ...
              {work.map((item) => (
                ...
                >
                  <div className="md:col-span-4 lg:col-span-3">
                    <span className="text-xs font-black text-emerald-500 dark:text-emerald-400 tracking-widest uppercase block mb-3">
                      {item.index}
                    </span>
