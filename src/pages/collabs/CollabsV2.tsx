...
const CollabsV2: React.FC = () => {
 ...
 return (
 <Layout>
 <div className="bg-white min-h-screen pt-32 pb-24" style={{ fontFamily: 'Inter, sans-serif' }}>
 ...
 >
 <div className="aspect-[4/3] w-full rounded-2xl relative overflow-hidden border border-gray-200 bg-gray-100">
 <img
 src={collab.image}
 alt={collab.name}
 loading="lazy"
 ...
 <span className="font-bold text-gray-900 text-base leading-snug transition-colors" style={{ fontFamily: 'Inter, sans-serif' }}>
 {collab.name}
 </span>
