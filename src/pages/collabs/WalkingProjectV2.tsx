...
const WalkingProjectV2: React.FC = () => {
 ...
 {/* Identity Section */}
 <section className="border-t border-gray-200 pt-10 pb-20 px-6 lg:px-16 max-w-[1440px] mx-auto">
 ...
 <div key={i} className="bg-gray-100 p-8 min-h-[180px] flex items-center justify-center">
 <button
 type="button"
 ...
 <p className="text-sm text-gray-700">Hex #FDC700</p>
 <p className="text-sm text-gray-700">RGB 253, 199, 0</p>
 <p className="text-sm text-gray-700">CMYK 0, 21, 100, 1</p>
 </div>
 <div className="border border-gray-200 rounded-xl p-6 flex flex-col justify-center">
 <p className="text-sm uppercase tracking-wide text-gray-500 mb-2">Typeface</p>
 <p className="text-4xl font-bold">Inter</p>
 <p className="text-sm text-gray-600 mt-2">Sans-serif for headlines, body, and digital readability.</p>
 </div>
 </div>
 </section>
 ...
 <section className="border-t border-gray-200 pt-10 pb-16 px-6 lg:px-16 max-w-[1440px] mx-auto">
 ...
 {/* Website Section */}
 <section className="border-t border-gray-200 pt-10 pb-24 px-6 lg:px-16 max-w-[1440px] mx-auto">
