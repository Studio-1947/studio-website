...
export default function LocalFutures() {
 ...
 <h1 className="mt-6 text-4xl md:text-6xl font-black text-gray-900 tracking-tight">
 Local Futures
 </h1>
 ...
 <div className="mt-10 rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-black">
