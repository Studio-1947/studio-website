...
const HelipadSection: React.FC = () => {
 ...
 className="w-full h-full object-cover opacity-80 mix-blend-luminosity transition-transform duration-[2000ms] ease-out hover:scale-105"
 loading="lazy"
 decoding="async"
 />
 </motion.div>
 ...
 Traditional consulting moves slowly and hides the real costs. We
 do the opposite. At{" "}
 <span className="font-medium text-white">Studio 1947</span>,
 communication stays direct, pricing stays transparent, and your
 money fuels the actual work rather than layers of overhead.
 </p>
 </motion.div>
 </div>
 ...
 className="group flex items-start gap-6 border-b border-white/10 pb-8 last:border-0 hover:border-white/30 transition-colors duration-500"
 >
