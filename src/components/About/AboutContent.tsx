...
const AboutContent: React.FC = () => {
 return (
 <section className="min-h-screen flex items-center py-12 md:py-0 bg-white text-gray-900 relative overflow-hidden transition-colors duration-300">
 ...
 <div className="h-1.5 w-24 bg-royal-700 rounded-full"></div>
 </div>
