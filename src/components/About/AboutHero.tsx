...
const AboutHero: React.FC = () => {
 ...
 <section 
 ref={containerRef} 
 className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-50 transition-colors duration-300"
 >
 ...
 <span className="text-[25vw] md:text-[20vh] leading-none font-bold text-gray-200 origin-center -rotate-90 md:translate-x-[-20%] whitespace-nowrap transition-colors duration-300">
 ABOUT
 </span>
 </div> */}
 ...
 <span className="block text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold text-gray-900 tracking-tighter leading-none mb-4 md:mb-6 transition-colors duration-300">
 We are
 </span>
 <div className="h-1 w-24 bg-royal-700 mx-auto md:ml-auto md:mr-0 mb-6 md:mb-8"></div>
 <p className="text-lg md:text-xl lg:text-2xl text-gray-600 font-medium max-w-sm mx-auto md:mx-0 transition-colors duration-300 leading-relaxed">
