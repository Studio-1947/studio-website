...
export default function SearchModal({ isOpen, onClose }: SearchModalProps) {
 ...
 >
 <div className="bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col max-h-[60vh]">
 ...
 className="w-full pl-10 pr-4 py-2 bg-transparent text-lg text-gray-900 placeholder-gray-400 focus:outline-none"
 placeholder="Search..."
 value={query}
 onChange={(e) => setQuery(e.target.value)}
 />
 <div className="hidden sm:flex text-xs text-gray-400 border border-gray-200 rounded px-1.5 py-0.5 ml-2">
 ESC
 </div>
 </div>
 ...
 <div className="hidden sm:flex px-4 py-3 bg-gray-50 border-t border-gray-100 text-xs text-gray-500 justify-end gap-4">
 <span className="flex items-center gap-1">
 <kbd className="font-sans px-1 py-0.5 rounded border border-gray-300 bg-white">↩</kbd>
 to select
 </span>
 <span className="flex items-center gap-1">
 <kbd className="font-sans px-1 py-0.5 rounded border border-gray-300 bg-white">↑↓</kbd>
