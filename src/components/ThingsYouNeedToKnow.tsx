...
export default function ThingsYouNeedToKnow() {
 ...
 {/* Image Placeholder */}
 <div className="w-full aspect-[4/3] bg-gray-100 rounded-xl relative flex items-center justify-center overflow-hidden">
 <div className="flex items-center gap-4 opacity-50">
 <div className="w-12 h-12 bg-gray-300 rounded-sm"></div>
 <div className="w-12 h-12 bg-gray-300 rounded-full"></div>
 <div className="w-0 h-0 border-l-[24px] border-l-transparent border-b-[48px] border-b-gray-300 border-r-[24px] border-r-transparent"></div>
 </div>
 </div>
 </div>
 ))}
