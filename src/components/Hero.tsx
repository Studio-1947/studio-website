                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div className="text-center lg:text-left z-10 flex flex-col justify-center items-center lg:items-start order-2 lg:order-1 w-full">
                            <div className="text-center lg:text-left w-full pl-10 lg:pl-0">
                                <div className="flex items-center text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 font-medium mb-4 justify-center lg:justify-start w-full">
                            ...
                            <Typography as="h1" variant="h1" gradient className="mb-6 lg:mb-8 pr-2 dark:from-primary-hero dark:via-primary-hero dark:to-purple-400">
                                Local Wisdom
