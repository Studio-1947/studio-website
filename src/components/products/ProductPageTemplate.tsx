...
export default function ProductPageTemplate({ product }: Props) {
 ...
 <div
 className="absolute inset-0 opacity-[0.07] scale-105"
 style={{
 ...
 className={`px-8 py-4 rounded-full font-bold transition-all cursor-pointer border border-black/10 shadow-xl hover:shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-royal-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${colors.primaryBtn}`}
 >
 Request a Demo
 </button>
 </div>
 ...
 <div
 key={i}
 className="bg-white rounded-2xl p-8 md:p-10 border border-gray-100 hover:shadow-lg transition-shadow duration-300"
 >
 <div
