  ...
  return (
    <div
      ...
      className={cn(
        ...
        "dark:[--cell-border-color:var(--color-gray-800)] dark:[--cell-fill-color:transparent] dark:[--cell-shadow-color:var(--color-gray-950)]",
      )}
    >
      ...
      {cells.map((idx) => {
        ...
        return (
          <div
            key={idx}
            className={cn(
              "cell relative border-[0.5px] border-white/5 opacity-40 transition-opacity duration-150 hover:opacity-80 dark:shadow-[0px_0px_40px_1px_var(--cell-shadow-color)_inset]",
