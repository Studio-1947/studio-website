export const solutionsData = [
  {
    ...
    description:
      "From market surveys with 800+ responses to deep user interviews, we provide SWOT reports, positioning strategy, and behavioral mapping.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      "We map processes, optimize workflows, design lifecycle customer journeys, and create structured SOP documentation for scale.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Building responsive business websites, e-commerce platforms with payment automation, and MVP Android/iOS mobile applications.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Managing monthly content, PR media relations, influencer partnerships executing optimized performance marketing setups.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
