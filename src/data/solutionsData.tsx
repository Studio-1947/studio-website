...
export const solutionsData = [
  {
    ...
    description: 'From market surveys with 800+ responses to deep user interviews, we provide SWOT reports, positioning strategy, and behavioral mapping.',
    icon: (
  ...
  },
  {
    ...
    description: 'We map processes, optimize workflows, design lifecycle customer journeys, and create structured SOP documentation for scale.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Transforming raw information into live KPI dashboards, structured datasets, and delivering monthly insight and recommendation reports.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Comprehensive ERP setups (HR, Billing, Inventory) alongside 24x7 monitored cloud hosting, security audits, and compliance.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Building responsive business websites, e-commerce platforms with payment automation, and MVP Android/iOS mobile applications.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Managing monthly content, PR media relations, influencer partnerships executing optimized performance marketing setups.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Executing 1-2 day corporate shoots, scripting and cutting brand films, and directing impactful documentary storytelling.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
