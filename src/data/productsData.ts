...
export const productColorConfig = {
  royal: {
    badge: 'bg-royal-100 text-royal-700 dark:bg-royal-900/30 dark:text-royal-300',
    primaryBtn: 'bg-royal-600 text-white hover:bg-royal-700 shadow-lg shadow-royal-600/25',
    iconBg: 'bg-royal-100 dark:bg-royal-900/50',
    iconText: 'text-royal-600 dark:text-royal-400',
    accentText: 'text-royal-600 dark:text-royal-400',
    statBorder: 'border-royal-100 dark:border-royal-900/50',
    featureBg: 'bg-gray-50 dark:bg-gray-800/50',
    divider: 'bg-royal-600',
  },
  emerald: {
    badge: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300',
    primaryBtn: 'bg-emerald-600 text-white hover:bg-emerald-700 shadow-lg shadow-emerald-600/25',
    iconBg: 'bg-emerald-100 dark:bg-emerald-900/50',
    iconText: 'text-emerald-600 dark:text-emerald-400',
    accentText: 'text-emerald-600 dark:text-emerald-400',
    statBorder: 'border-emerald-100 dark:border-emerald-900/50',
    featureBg: 'bg-gray-50 dark:bg-gray-800/50',
    divider: 'bg-emerald-600',
  },
  indigo: {
    badge: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300',
    primaryBtn: 'bg-indigo-600 text-white hover:bg-indigo-700 shadow-lg shadow-indigo-600/25',
    iconBg: 'bg-indigo-100 dark:bg-indigo-900/50',
    iconText: 'text-indigo-600 dark:text-indigo-400',
    accentText: 'text-indigo-600 dark:text-indigo-400',
    statBorder: 'border-indigo-100 dark:border-indigo-900/50',
    featureBg: 'bg-gray-50 dark:bg-gray-800/50',
    divider: 'bg-indigo-600',
  },
  rose: {
    badge: 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300',
    primaryBtn: 'bg-rose-600 text-white hover:bg-rose-700 shadow-lg shadow-rose-600/25',
    iconBg: 'bg-rose-100 dark:bg-rose-900/50',
    iconText: 'text-rose-600 dark:text-rose-400',
    accentText: 'text-rose-600 dark:text-rose-400',
    statBorder: 'border-rose-100 dark:border-rose-900/50',
    featureBg: 'bg-gray-50 dark:bg-gray-800/50',
    divider: 'bg-rose-600',
  },
};
...
export const products: Product[] = [
  {
    slug: 'doptor',
    name: 'Doptor',
    tagline: 'An office management system built for how modern teams actually work.',
  ...
  },
  {
    slug: 'angan',
    name: 'Aangan',
    tagline: 'A homestay management platform rooted in the realities of independent hospitality.',
